...
GENERAL_CLARIFY_RESPONSE = (
    "หนูมีประกันรถยนต์และประกันชีวิตให้บริการค่ะ "
    "สนใจแบบไหนดีคะ เลือกจากปุ่มด้านล่างได้เลยค่ะ"
    "[OPTIONS:ประกันรถยนต์:🚗 ประกันรถยนต์|ประกันชีวิต:❤️ ประกันชีวิต]"
)

LIFE_CLARIFY_RESPONSE = (
    "หนูมีข้อมูลเรื่องความคุ้มครอง เบี้ยประกัน การเคลม "
    "ผู้รับประโยชน์ และการกู้เงินกรมธรรม์ค่ะ สนใจเรื่องไหนดีคะ"
    "[OPTIONS:ความคุ้มครอง|เบี้ยประกัน|การเคลม|ผู้รับประโยชน์|กู้เงินกรมธรรม์]"
)

CAR_CLARIFY_RESPONSE = (
    "หนูมีข้อมูลเรื่องความคุ้มครอง เบี้ยประกัน การเคลม "
    "และโปรโมชั่นค่ะ สนใจเรื่องไหนดีคะ"
